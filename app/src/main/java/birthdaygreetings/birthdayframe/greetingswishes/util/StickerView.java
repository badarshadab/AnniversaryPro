...
public abstract class StickerView extends FrameLayout {
    ...
    private final boolean isInEdit = true;
    // For scalling
    ...
    private void init(Context context) {
        ...
        this.iv_delete.setImageResource(R.drawable.delete_new);
        this.iv_flip.setImageResource(R.drawable.flip);
        this.iv_done.setImageResource(R.drawable.ok_new);
        ...
        this_params.gravity = Gravity.FILL;
        ...
        iv_done_params.gravity = Gravity.BOTTOM | Gravity.LEFT;
